...
# import calculated yield data for series of test dates and sort in ascending order
...
# NB: 'PVGEDT_Yield_Wh' is the standard model, 'LF_PVGEDT_Yield_Wh' assumes a 12\% 
# loss factor based on the fit to the 13th October 2023
...
############ plot line of best fit and get linear regression statistics #########
...
# perform linear regression for standard PV_GEDT model
...
# perform linear regression for PV-GEDT with a 12\% loss factor
